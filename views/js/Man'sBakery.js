...
function highlightBakery(idTable, bShowBaked) {
    // if bShowBaked is true, then we're highlighting bakery
    ...
    // "bakery" attribute on it.
    for (i = 0; i < aTRs.length; i++) {
        if (aTRs[i].getAttribute('bakery') == "true") {
            if (bShowBaked) {
