...
router.get('/get/html', function (req, res) {
    ...
    var xml = fs.readFileSync('MansBakery.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('MansBakery.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function (req, res) {
    ...
    function appendJSON(obj) {
        ...
        xmlFileToJs('MansBakery.xml', function (err, result) {
            if (err) throw (err);

            result.bakerymenu.section[obj.sec_n].entree.push({ 'item': obj.item, 'price': obj.price });

            console.log(JSON.stringify(result, null, "  "));

            jsToXmlFile('MansBakery.xml', result, function (err) {
...
router.post('/post/delete', function (req, res) {
    ...
    function deleteJSON(obj) {
        ...
        xmlFileToJs('MansBakery.xml', function (err, result) {
            ...
            delete result.bakerymenu.section[obj.section].entree[obj.entree];
